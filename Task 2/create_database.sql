...
CREATE TABLE instrument_in_stock  (
 instument_in_stock_id CHAR(10) NOT NULL,
 instrument_id INT NOT NULL,
...
ALTER TABLE student_contact_person ADD CONSTRAINT FK_student_contact_person_0 FOREIGN KEY (person_id) REFERENCES person (person_id);
...
ALTER TABLE current_skill ADD CONSTRAINT FK_current_skill_0 FOREIGN KEY (student_id) REFERENCES student (student_id);
ALTER TABLE current_skill ADD CONSTRAINT FK_current_skill_1 FOREIGN KEY (skill_level_id) REFERENCES skill_level (skill_level_id);
ALTER TABLE current_skill ADD CONSTRAINT FK_current_skill_2 FOREIGN KEY (instrument_id) REFERENCES instrument (instrument_id);
...
ALTER TABLE lesson_price ADD CONSTRAINT FK_lesson_price_0 FOREIGN KEY (lesson_type_id) REFERENCES lesson_type (lesson_type_id);
ALTER TABLE lesson_price ADD CONSTRAINT FK_lesson_price_1 FOREIGN KEY (skill_level_id) REFERENCES skill_level (skill_level_id);
...
ALTER TABLE ensemble ADD CONSTRAINT FK_ensemble_1 FOREIGN KEY (lesson_price_id) REFERENCES lesson_price (lesson_price_id);
ALTER TABLE ensemble ADD CONSTRAINT FK_ensemble_2 FOREIGN KEY (genre_id) REFERENCES genre (genre_id);
ALTER TABLE ensemble ADD CONSTRAINT FK_ensemble_3 FOREIGN KEY (time_slot_id) REFERENCES time_slot  (time_slot_id);


ALTER TABLE group_lesson ADD CONSTRAINT FK_group_lesson_0 FOREIGN KEY (instructor_id) REFERENCES instructor (instructor_id);
ALTER TABLE group_lesson ADD CONSTRAINT FK_group_lesson_1 FOREIGN KEY (skill_level_id) REFERENCES skill_level (skill_level_id);
ALTER TABLE group_lesson ADD CONSTRAINT FK_group_lesson_2 FOREIGN KEY (lesson_price_id) REFERENCES lesson_price (lesson_price_id);
ALTER TABLE group_lesson ADD CONSTRAINT FK_group_lesson_3 FOREIGN KEY (instrument_id) REFERENCES instrument (instrument_id);
ALTER TABLE group_lesson ADD CONSTRAINT FK_group_lesson_4 FOREIGN KEY (time_slot_id) REFERENCES time_slot  (time_slot_id);
...
ALTER TABLE instrument_in_stock  ADD CONSTRAINT FK_instrument_in_stock_1 FOREIGN KEY (rental_id) REFERENCES rental (rental_id);


ALTER TABLE student_in_ensemble ADD CONSTRAINT FK_student_in_ensemble_0 FOREIGN KEY (student_id) REFERENCES student (student_id);
ALTER TABLE student_in_ensemble ADD CONSTRAINT FK_student_in_ensemble_1 FOREIGN KEY (ensemble_id) REFERENCES ensemble (ensemble_id);


ALTER TABLE student_in_group_lesson ADD CONSTRAINT FK_student_in_group_lesson_0 FOREIGN KEY (student_id) REFERENCES student (student_id);
ALTER TABLE student_in_group_lesson ADD CONSTRAINT FK_student_in_group_lesson_1 FOREIGN KEY (group_lesson_id) REFERENCES group_lesson (group_lesson_id);
